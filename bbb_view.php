    ...
    case 'logout':
        if (isset($errors) && $errors != '') {
          bigbluebutton_bbb_view_errors($errors, $id);
            ...
            // Update the cache.
            $meeting_info = bigbluebuttonbn_bbb_broker_get_meeting_info(
            	$bbbsession['meetingid'], $bbbsession['modPW'], BIGBLUEBUTTONBN_FORCED, $bbbsession['server']
            );
...
function bigbluebutton_bbb_view_execute_join($bbbsession, $cm, $context, $bigbluebuttonbn) {
    // Update the cache.
    $meeting_info = bigbluebuttonbn_bbb_broker_get_meeting_info(
    	$bbbsession['meetingid'], $bbbsession['modPW'], true, $bigbluebuttonbn->server
    );
