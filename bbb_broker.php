...
$endpoint = bigbluebuttonbn_get_cfg_server_url($bigbluebuttonbn->server);
$shared_secret = bigbluebuttonbn_get_cfg_shared_secret($bigbluebuttonbn->server);
            ...
            switch (strtolower($params['action'])) {
                ...
                case 'meeting_end':
                    if( $bbbsession['administrator'] || $bbbsession['moderator'] ) {
                        ...
                        $meeting_info = bigbluebuttonbn_bbb_broker_do_end_meeting($params['id'], $bbbsession['modPW'], $bbbsession['server']);
                ...
                case 'recording_publish':
                    if ($bbbsession['managerecordings']) {
                        ...
                        if (isset($recordings_imported_indexed[$params['id']])) {
                            ...
                            $meeting_info = bigbluebuttonbn_bbb_broker_do_publish_recording($params['id'], true, $bbbsession['server']);
                        }
                ...
                case 'recording_unpublish':
                    if ($bbbsession['managerecordings']) {
                        ...
                        if (isset($recordings_indexed[$params['id']])) {
                            ...
                            $meeting_info = bigbluebuttonbn_bbb_broker_do_publish_recording($params['id'], false, $bbbsession['server']);
                        }
                ...
                case 'recording_delete':
                    if ($bbbsession['managerecordings']) {
                        ...
                        if (isset($recordings_indexed[$params['id']])) {
                            ...
                            $meeting_info = bigbluebuttonbn_bbb_broker_do_delete_recording($params['id'], $bbbsession['server']);
                        }
