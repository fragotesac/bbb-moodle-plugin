...
function bigbluebuttonbn_bbb_broker_get_recordings($meetingid, $password, $forced=false, $server = null) {
    global $CFG;

    $recordings = array();
    $endpoint = bigbluebuttonbn_get_cfg_server_url($server);
    $shared_secret = bigbluebuttonbn_get_cfg_shared_secret($server);
...
function bigbluebuttonbn_bbb_broker_get_meeting_info($meetingid, $password, $forced=false, $server = null) {
    global $CFG;
...
function bigbluebuttonbn_bbb_broker_do_end_meeting($meetingid, $password, $server = null){
    global $CFG;
...
function bigbluebuttonbn_bbb_broker_do_publish_recording($recordingid, $publish=true, $server = null){
    global $CFG;
...
function bigbluebuttonbn_bbb_broker_do_delete_recording($recordingid, $server = null){
    global $CFG;
...
function bigbluebuttonbn_server_offers($capability_name, $server = null){
    global $CFG;
...
function bigbluebuttonbn_server_offers_bn_capabilities($server = null){
    //Validates if the server may have extended capabilities
    $parsed_url = parse_url(bigbluebuttonbn_get_cfg_server_url($server));
